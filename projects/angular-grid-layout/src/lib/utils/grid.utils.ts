...
export function ktdGridItemDragging(
    ...
    const gridElementTopPosition =
        gridElemClientRect.top + scrollDifference.top;
...
export function ktdGridItemResizing(
    ...
    const resizeElemOffsetX =
        dragElemClientRect.width - (clientStartX - dragElemClientRect.left);
    const resizeElemOffsetY =
    ...
    const width =
        clientX +
        resizeElemOffsetX -
        (dragElemClientRect.left + scrollDifference.left);
    const height =
        clientY +
        resizeElemOffsetY -
        (dragElemClientRect.top + scrollDifference.top);
